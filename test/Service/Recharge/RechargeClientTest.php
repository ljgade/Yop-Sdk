...
class RechargeClientTest extends TestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$client = RechargeClientBuilder::builder($appSdkConfig)->build();
    }

    /**
     * @test
     */
    public function bankAccountQueryTest()
    {
        $request = new Model\BankAccountQueryRequest();
        ...
        try{
            $response = self::$client->bankAccountQuery($request);
