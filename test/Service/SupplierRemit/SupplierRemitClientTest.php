...
class SupplierRemitClientTest extends TestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$client = SupplierRemitClientBuilder::builder($appSdkConfig)->build();
    }

    /**
     * @test
     */
    public function billDownloadTest()
    {
        $request = new Model\BillDownloadRequest();

        $request->setRemitDate("remitDate_example");
        try{
            $response = self::$client->billDownload($request);
