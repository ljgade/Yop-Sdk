...
class AtVccClientTest extends TestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$client = AtVccClientBuilder::builder($appSdkConfig)->build();
    }

    /**
     * @test
     */
    public function unionPayOrderQueryTest()
    {
        $request = new Model\UnionPayOrderQueryRequest();
        ...
        try{
            $response = self::$client->unionPayOrderQuery($request);
