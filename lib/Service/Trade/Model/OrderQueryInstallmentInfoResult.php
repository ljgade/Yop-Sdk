...
/**
 * OrderQueryInstallmentInfoResult Class Doc Comment
 *
 * @category Class
 * @description 信用卡分期信息
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OrderQueryInstallmentInfoResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OrderQueryInstallmentInfoResult';
     ...
     * Sets instNumber
     *
     * @param string $instNumber 信用卡分期期数
     *
     * @return $this
     */
