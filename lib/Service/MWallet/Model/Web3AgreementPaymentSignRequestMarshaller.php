...
class Web3AgreementPaymentSignRequestMarshaller implements RequestMarshaller
{
    /**
     * @var Web3AgreementPaymentSignRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new Web3AgreementPaymentSignRequestMarshaller();
    }

    /**
     * @return Web3AgreementPaymentSignRequestMarshaller
     */
    ...
    /**
     * @param Web3AgreementPaymentSignRequest $request
     * @return Request
     */
...
Web3AgreementPaymentSignRequestMarshaller::__init();
