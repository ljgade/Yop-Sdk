...
class TradeAutoDeductionCreateRequestMarshaller implements RequestMarshaller
{
    /**
     * @var TradeAutoDeductionCreateRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new TradeAutoDeductionCreateRequestMarshaller();
    }

    /**
     * @return TradeAutoDeductionCreateRequestMarshaller
     */
    ...
    /**
     * @param TradeAutoDeductionCreateRequest $request
     * @return Request
     */
...
TradeAutoDeductionCreateRequestMarshaller::__init();
