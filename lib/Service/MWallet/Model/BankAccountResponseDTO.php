...
/**
 * BankAccountResponseDTO Class Doc Comment
 *
 * @category Class
 * @description 响应结果
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BankAccountResponseDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BankAccountResponseDTO';
     ...
     * Sets yeepayOrderNo
     *
     * @param string $yeepayOrderNo 易宝开户请求号
     *
     * @return $this
     */
     ...
     * Sets applyStatus
     *
     * @param string $applyStatus 开户状态<br>可选项如下:<br>UNACTIVATED:处理中-等待回填短验<br>FAIL:开户失败
     *
     * @return $this
     */
