...
class BillQueryListRequestMarshaller implements RequestMarshaller
{
    /**
     * @var BillQueryListRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new BillQueryListRequestMarshaller();
    }

    /**
     * @return BillQueryListRequestMarshaller
     */
     ...
     * @var string
     */
    private $resourcePath = '/rest/v1.0/m-wallet/bill/query-list';
    ...
    /**
     * @param BillQueryListRequest $request
     * @return Request
     */
...
BillQueryListRequestMarshaller::__init();
