...
/**
 * ConfirmBankAccountResponseDTO Class Doc Comment
 *
 * @category Class
 * @description 响应结果
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ConfirmBankAccountResponseDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConfirmBankAccountResponseDTO';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['retryConfirm'] = isset($data['retryConfirm']) ? $data['retryConfirm'] : null;
    }
     ...
     * Sets applyStatus
     *
     * @param string $applyStatus 开户状态<br>可选项如下:<br>UNACTIVATED:开户成功-卡片激活失败<br>SUCCESS:开户成功-卡片激活成功<br>FAIL:开户失败
     *
     * @return $this
     */
     ...
     * Sets yeepayMemberNo
     *
     * @param string $yeepayMemberNo 易宝会员号
     *
     * @return $this
     */
     ...
     * @return string
     */
    public function getRetryConfirm()
    {
        return $this->container['retryConfirm'];
    }

    /**
     * Sets retryConfirm
     *
     * @param string $retryConfirm 是否可以重试<br>可选项如下:<br>ON:可以重试<br>OFF:不可以重试
     *
     * @return $this
     */
    public function setRetryConfirm($retryConfirm)
    {
        $this->container['retryConfirm'] = $retryConfirm;
