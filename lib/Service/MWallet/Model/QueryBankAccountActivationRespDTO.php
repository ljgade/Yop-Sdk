<?php
/**
 * QueryBankAccountActivationRespDTO
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * QueryBankAccountActivationRespDTO Class Doc Comment
 *
 * @category Class
 * @description 响应结果
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class QueryBankAccountActivationRespDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'QueryBankAccountActivationRespDTO';
     ...
     * Sets status
     *
     * @param string $status 状态<br>可选项如下:<br>SUCCESS:成功<br>FAIL:失败<br>PROCESS:处理中
     *
     * @return $this
     */
