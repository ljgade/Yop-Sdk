...
/**
 * BankShortMsgResponseDTO Class Doc Comment
 *
 * @category Class
 * @description 响应结果
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BankShortMsgResponseDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BankShortMsgResponseDTO';
     ...
     * Sets status
     *
     * @param string $status 发送状态<br>可选项如下:<br>SUCCESS:成功<br>FAIL:失败
     *
     * @return $this
     */
