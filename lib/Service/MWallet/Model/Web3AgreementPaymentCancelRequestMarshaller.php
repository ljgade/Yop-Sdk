...
class Web3AgreementPaymentCancelRequestMarshaller implements RequestMarshaller
{
    /**
     * @var Web3AgreementPaymentCancelRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new Web3AgreementPaymentCancelRequestMarshaller();
    }

    /**
     * @return Web3AgreementPaymentCancelRequestMarshaller
     */
    ...
    /**
     * @param Web3AgreementPaymentCancelRequest $request
     * @return Request
     */
...
Web3AgreementPaymentCancelRequestMarshaller::__init();
