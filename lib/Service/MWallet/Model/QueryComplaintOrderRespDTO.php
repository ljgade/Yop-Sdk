...
/**
 * QueryComplaintOrderRespDTO Class Doc Comment
 *
 * @category Class
 * @description 响应结果
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class QueryComplaintOrderRespDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'QueryComplaintOrderRespDTO';
    ...
    protected static $setters = [
        ...
        'bankTradeNo' => 'setBankTradeNo',
        'amountGear' => 'setAmountGear',
    ...
    protected static $getters = [
        ...
        'bankTradeNo' => 'getBankTradeNo',
        'amountGear' => 'getAmountGear',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['bankTradeNo'] = isset($data['bankTradeNo']) ? $data['bankTradeNo'] : null;
        $this->container['amountGear'] = isset($data['amountGear']) ? $data['amountGear'] : null;
     ...
     * Sets tradeTime
     *
     * @param string $tradeTime 订单交易日期<br>参数格式为：yyyyMMdd
     *
     * @return $this
     */
    ...
    {
        return $this->container['bankTradeNo'];
    }

    /**
     * Sets bankTradeNo
     *
     * @param string $bankTradeNo 银行交易流水
     *
     * @return $this
     */
    public function setBankTradeNo($bankTradeNo)
    {
        $this->container['bankTradeNo'] = $bankTradeNo;
     ...
     * @return string
     */
    public function getAmountGear()
    {
        return $this->container['amountGear'];
    }

    /**
     * Sets amountGear
     *
     * @param string $amountGear 交易金额档位
     *
     * @return $this
     */
    public function setAmountGear($amountGear)
    {
        $this->container['amountGear'] = $amountGear;
     ...
     * Sets tradeType
     *
     * @param string $tradeType 交易类型<br>可选项如下:<br>PAY:支付<br>REFUND:退款
     *
     * @return $this
     */
