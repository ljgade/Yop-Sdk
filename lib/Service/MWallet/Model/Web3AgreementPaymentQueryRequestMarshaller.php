...
class Web3AgreementPaymentQueryRequestMarshaller implements RequestMarshaller
{
    /**
     * @var Web3AgreementPaymentQueryRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new Web3AgreementPaymentQueryRequestMarshaller();
    }

    /**
     * @return Web3AgreementPaymentQueryRequestMarshaller
     */
    ...
    /**
     * @param Web3AgreementPaymentQueryRequest $request
     * @return Request
     */
...
Web3AgreementPaymentQueryRequestMarshaller::__init();
