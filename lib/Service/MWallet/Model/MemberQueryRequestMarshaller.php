...
class MemberQueryRequestMarshaller implements RequestMarshaller
{
    /**
     * @var MemberQueryRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new MemberQueryRequestMarshaller();
    }

    /**
     * @return MemberQueryRequestMarshaller
     */
     ...
     * @var string
     */
    private $resourcePath = '/rest/v1.0/m-wallet/member/query';
    ...
    /**
     * @param MemberQueryRequest $request
     * @return Request
     */
...
MemberQueryRequestMarshaller::__init();
