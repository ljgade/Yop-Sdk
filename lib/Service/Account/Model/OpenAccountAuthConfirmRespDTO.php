...
/**
 * OpenAccountAuthConfirmRespDTO Class Doc Comment
 *
 * @category Class
 * @description 短验确认返参
 * @package  Yeepay\Yop\Sdk\
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OpenAccountAuthConfirmRespDTO implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OpenAccountAuthConfirmRespDTO';
     ...
     * Sets status
     *
     * @param string $status <p>响应状态：</p> <div data-page-id=\"LeHwdQ4vto5Jaaxfth6c46aHnMe\" data-docx-has-block-data=\"false\"> <div class=\"ace-line ace-line old-record-id-Fs1RdcyHvo96VtxeUJrcPHignIc\"><em>SUCCESS 成功</em> <br /><em>FAIL 失败</em></div> </div>
     *
     * @return $this
     */
