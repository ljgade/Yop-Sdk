...
class TransferWechatOrderRequestMarshaller implements RequestMarshaller
{
    /**
     * @var TransferWechatOrderRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new TransferWechatOrderRequestMarshaller();
    }

    /**
     * @return TransferWechatOrderRequestMarshaller
     */
     ...
     * @var string
     */
    private $resourcePath = '/rest/v1.0/account/transfer/wechat/order';
    ...
    /**
     * @param TransferWechatOrderRequest $request
     * @return Request
     */
...
TransferWechatOrderRequestMarshaller::__init();
