...
/**
 * RechargeEBankRequestDTOParam Class Doc Comment
 *
 * @category Class
 * @description 网银充值扩展参数,充值方式为B2B/B2C时必填
 * @package  Yeepay\Yop\Sdk\
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RechargeEBankRequestDTOParam implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RechargeEBankRequestDTOParam';
