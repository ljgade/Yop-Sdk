...
class BillFundbillFlowQueryRequestMarshaller implements RequestMarshaller
{
    /**
     * @var BillFundbillFlowQueryRequestMarshaller
     */
    private static $instance;

    public static function __init()
    {
        self::$instance = new BillFundbillFlowQueryRequestMarshaller();
    }

    /**
     * @return BillFundbillFlowQueryRequestMarshaller
     */
    ...
    /**
     * @param BillFundbillFlowQueryRequest $request
     * @return Request
     */
...
BillFundbillFlowQueryRequestMarshaller::__init();
